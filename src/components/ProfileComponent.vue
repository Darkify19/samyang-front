<template>
    <div class="profile-container container">
        ...
        <div class="user-info" v-if="user">
            ...
            <img :src="userPhotos.length ? userPhotos[0].url : defaultPlaceholder" alt="Profile Picture"
...
export default {
    ...
    methods: {
        ...
        async uploadPhotoToBackend(url) {
            ...
            try {
                const { data } = await this.$apollo.mutate({
                    ...
                    variables: { input: { userId: this.user.id, url } },
                });
